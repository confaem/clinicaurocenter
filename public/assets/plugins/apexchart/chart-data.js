...
document.addEventListener('DOMContentLoaded', function() {
  ...
  if(document.getElementById('reservation-chart')) {
    var sCol = {
        chart: {
            width: '100%',
  ...
  //Report Chart
  if(document.getElementById('report_chart')) {
    var options = {
      series: [{
  ...
  if(document.getElementById('report_chart_2')) {
    var options = {
      series: [{
        data: [0, 6, 24, 14, 20, 15, 37]
      }],
  ...
  if(document.getElementById('report_chart_3')) {
    var options = {
      series: [{
        data: [0, 6, 24, 14, 20, 15, 37]
      }],
  ...
  if(document.getElementById('report_chart_4')) {
    var options = {
      series: [{
        data: [0, 6, 24, 14, 20, 15, 37]
      }],
  ...
  if(document.getElementById('payment_report_chart')) {
    var options = {
      series: [{
        data: [0, 6, 24, 14, 20, 15, 37]
      }],
  ...
  if(document.getElementById('payment_report_chart_2')) {
    var options = {
      series: [{
        data: [0, 6, 24, 14, 20, 15, 37]
      }],
  ...
  if(document.getElementById('payment_report_chart_3')) {
    var options = {
      series: [{
        data: [0, 6, 24, 14, 20, 15, 37]
      }],
  ...
  if(document.getElementById('payment_report_chart_4')) {
    var options = {
      series: [{
        data: [0, 6, 24, 14, 20, 15, 37]
      }],
  ...
  if(document.getElementById('register-chart')) {
    var sCol = {
      chart: {
        height: 320,
        type: 'area',
  ...
  if(document.getElementById('plane-chart')) {
    var options = {
      series: [{
  ...
  if(document.getElementById('radial-chart')) {
   ...
   // Radial Chart2
   if(document.getElementById('radial-chart2')) {
    var options = {
      chart: {
        type: 'donut',
        height: 164,
   ...
   // Radial Chart3
   if(document.getElementById('radial-chart3')) {
    var options = {
      chart: {
        type: 'donut',
        height: 49,
    ...
    chart.render();
     ...
     // Radial Chart4
     if(document.getElementById('radial-chart4')) {
      var options = {
        chart: {
          type: 'donut',
          height: 49,
    ...
    // Radial Chart5
    if(document.getElementById('radial-chart5')) {
    var options = {
      chart: {
        type: 'donut',
        height: 49,
  ...
  // Radial Chart6
    if(document.getElementById('radial-chart6')) {
    var options = {
      chart: {
        type: 'donut',
        height: 49,
  ...
  // Radial Chart7
  if(document.getElementById('radial-chart7')) {
    var options = {
      chart: {
        type: 'donut',
        height: 49,
  ...
  // Radial Chart8
  if(document.getElementById('radial-chart8')) {
    var options = {
      chart: {
        type: 'donut',
        height: 49,
  ...
  // Radial Chart9
  if(document.getElementById('radial-chart9')) {
    var options = {
      chart: {
        type: 'donut',
        height: 49,
  ...
  // Radial Chart10
  if(document.getElementById('radial-chart10')) {
    var options = {
      chart: {
        type: 'donut',
        height: 49,
    ...
    // Radial Chart11
    if(document.getElementById('radial-chart11')) {
      var options = {
        chart: {
          type: 'donut',
          height: 49,
    ...
    // Radial Chart12
    if(document.getElementById('radial-chart12')) {
      var options = {
        chart: {
          type: 'donut',
          height: 49,
    ...
    // Radial Chart13
    if(document.getElementById('radial-chart13')) {
      var options = {
        chart: {
          type: 'donut',
          height: 49,
    ...
    // Radial Chart14
    if(document.getElementById('radial-chart14')) {
      var options = {
        chart: {
          type: 'donut',
          height: 49,
  ...
  if(document.getElementById('web_chart')) {
    var donutChart = {
      chart: {
        height: 205,
        type: 'donut',
...
if(document.getElementById('productive-chart')) {
...
if(document.getElementById('unproductive-chart')) {
...
// web app chart
if(document.getElementById('web_app_chart')) {
  var donutChart = {
    chart: {
      height: 284,
      type: 'donut',
...
// app chart
if(document.getElementById('car-chart')) {
  var sCol = {
    chart: {
      width: '100',
      height: 90,
...
if(document.getElementById('summary_chart')) {
  var options = {
    chart: {
      type: 'heatmap',
      height: 330,toolbar: {
...
if(document.getElementById('hours_chart')) {
  var options = {
    series: [{
    name: 'Worked Hours',
    data: [8, 6, 5, 6, 5, 7],
  ...
  if(document.getElementById('total_tasks')) {
    var options = {
...
// Simple Line Area
if(document.getElementById('invoice_income')) {
  var sLineArea = {
    chart: {
      height: 60,
      type: 'area',
...
// Revenue
if(document.getElementById('sales_analytics')) {
  var sColStacked = {
    chart: {
      height: 300,
      type: 'bar',
...
if(document.getElementById('invoice_analytics')) {
  var options = {
...
// s-col-1
if(document.getElementById('s-col-1')) {
  var sCol = {
    chart: {
      width: 40,
      height: 54,
...
// s-col-2
if(document.getElementById('s-col-2')) {
  var sCol = {
    chart: {
      width: 40,
      height: 54,
...
// s-col-3
if(document.getElementById('s-col-3')) {
  var sCol = {
    chart: {
      width: 40,
      height: 54,
...
// s-col-4
if(document.getElementById('s-col-4')) {
  var sCol = {
    chart: {
      width: 40,
      height: 54,
...
// chart 7
if(document.getElementById('transaction-chart')) {
  var sCol = {
    chart: {
      height: 290,
      type: 'bar',
...
// s-col-4
if(document.getElementById('chart-col-4')) {
  var sCol = {
    chart: {
      width: 100,
      height: 54,
...
if(document.getElementById('productivetime-chart')) {
  var sCol = {
    chart: {
      width: '100%',
      height: 60,
...
if(document.getElementById('unproductivetime-chart')) {
  var sCol = {
    chart: {
      width: '100%',
      height: 60,
...
if(document.getElementById('manualtime-chart')) {
  var sCol = {
    chart: {
      width: '100%',
      height: 60,
...
if(document.getElementById('worktime-chart')) {
  var sCol = {
    chart: {
      width: '100%',
      height: 60,
...
// Production Chart
if(document.getElementById('production_chart')) {
  var radialChart = {
    chart: {
      //height: '130px',
      //width: '100%',
...
if(document.getElementById('patients-visits')) {
  var Patientsoptions = {
        series: [100, 80],
        chart: {
            height: 200,
