        ...
        var calendar = new FullCalendar.Calendar(calendarEl, {
          ...
          dateClick: function(info) {
            ...
            if (info.dayEl && !info.dayEl.querySelector('.fc-event')) {
              ...
              new bootstrap.Modal(document.getElementById('add_new')).show();
...
if(document.querySelectorAll('#calendar1').length > 0) {
...
if(document.querySelectorAll('#calendar-appointment').length > 0) {
          ...
          start: 'prev,next today',
               ...
               sanitize: false, 
                ...
                popoverEl.querySelectorAll('[data-bs-target="#appointment_details"]').forEach(el => {
					...
					eventEl.querySelectorAll('[data-bs-toggle="tooltip"]').forEach(function(el) {
